export const projects = {
  page: {
    ...
    description:
      "Uma seleção de projetos que mostram minha experiência com backend, automação, integrações, arquitetura e tecnologia aplicada a negócios.",
  },
  ...
  detail: {
    ...
    relatedCaseStudyDescription:
      "Leia também o artigo técnico relacionado a este projeto, com mais detalhes sobre decisões, desafios e aprendizados.",
  ...
  items: [
    ...
    },
    {
      ...
      technologies: ["RabbitMQ", ".NET", "SQL Server", "Mensageria"],
      gallery: [],
      demoUrl: "",
      videoUrl: "",
      githubUrl: "https://github.com/geovanarosamendes",
